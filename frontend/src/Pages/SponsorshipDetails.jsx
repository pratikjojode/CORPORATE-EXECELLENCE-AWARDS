...
const SponsorshipDetails = () => {
  // State to manage the visibility of contact information
  const [showContactInfo, setShowContactInfo] = useState(false);

  // Consolidated sponsorship data with all benefits included directly
  const sponsorshipPackages = [
    {
      ...
      color: "#FCD34D" // Goldish color for Platinum
    },
    {
      category: "Gold", 
      price: "₹ 15 Lakhs",
      ...
      color: "#C0C0C0" // Silver-like color for Gold
    },
    {
      category: "Silver",
      price: "₹ 10 Lakhs", 
      ...
      color: "#E5E7EB" // Lighter gray for Silver
    },
    {
      ...
      color: "#8B5CF6" // Purple from theme for Academic Partner
    }
  ];
      ...
      <div className="section-container">
        ...
        <div className="contact-section">
          ...
          <div className="contact-actions">
            <button className="contact-btn" onClick={toggleContactInfo}>
              Contact Sponsorship Team
            </button>
          </div>
          
          {/* Animated contact info display */}
          {showContactInfo && (
