  ...
  const events = [
    {
      ...
      notableAwardees: [
        { name: "Jignesh Patel", company: "Jivika Healthcare Pvt. Ltd", position: "CEO" },
        { name: "Akashanand Karnik", company: "1point 1solutions", position: "CEO" },
        { name: "Prashant Kesari", company: "Emotorad", position: "CFO" },
        { name: "Rohit Gupta", company: "Thyssenkrupp", position: "MD" }
      ],
      academicGuests: [
        { name: "Dr. Parag Kalkar", position: "Pro-Vice Chancellor", institution: "Savitribai Phule Pune University" },
        { name: "Prof. Viraj Barge", position: "Dean Training & Placement", institution: "Zeal Education Society" }
      ]
    },
    {
      year: "2024",
      ...
      notableAwardees: [
        { name: "Girish Desai", company: "PCET", position: "Executive Director" },
        { name: "Dr. Geetika Madan", company: "Weikfield", position: "Group Head TM & OD" },
        { name: "Neeraj Kumar Gupta", company: "Knorr-Bremse", position: "HR Director" },
        { name: "Vinod Bidwaik", company: "Alfa Laval", position: "VP-HR & CHRO" }
      ]
    },
    {
      year: "2023",
      ...
      notableAwardees: [
        { name: "Ajay Mudliar", company: "Tech Mahindra", position: "Head-Talent Acquisition" },
        { name: "Andrew Simon", company: "eClerx Services", position: "Head-Talent Acquisition" },
        { name: "Swapna Sangari", company: "Quick Heal", position: "Vice President-HR" },
        { name: "Rahul Bagale", company: "Force Motors", position: "Group Head-HR" }
      ]
    },
    {
      year: "2023",
      ...
      notableGuests: [
        { name: "Dr. Sandeep Sahasrabudhe", position: "Managing Director", company: "Pinewoods Golf Club" },
        { name: "Dr. Amit Andre", position: "CEO", company: "The Data Tech Labs" },
    ...
    <section id="events" className="events-section">
      <div className="section-container">
        <div className="section-header">
          ...
          <p className="section-subtitle">Celebrating Excellence Across Years</p>
        </div>
            ...
            <div className="event-card-main">
              <div className="event-header">
                ...
                <div className="event-meta">
                  <span className="event-year-large">{events[activeEvent].year}</span>
                  <span className="event-location">{events[activeEvent].location}</span>
                </div>
              </div>
                ...
                {events[activeEvent].notableAwardees && (
                  <div className="notable-awardees">
                    ...
                    <div className="awardees-grid">
                      {events[activeEvent].notableAwardees.slice(0, 4).map((awardee, index) => (
                ...
                {events[activeEvent].academicGuests && (
                  <div className="academic-guests">
                    ...
                    <div className="guests-list">
                      {events[activeEvent].academicGuests.map((guest, index) => (
                        <div key={index} className="guest-item">
                          <h5>{guest.name}</h5>
                          <p>{guest.position}, {guest.institution}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="notable-guests">
                    ...
                    <div className="guests-list">
                      {events[activeEvent].notableGuests.map((guest, index) => (
                        <div key={index} className="guest-item">
                          <h5>{guest.name}</h5>
                          <p>{guest.position}, {guest.company}</p>
                        </div>
                      ))}
                    </div>
                  </div>
