...
const NominationProcess = () => {
  ...
  const steps = [
    {
      ...
      date: "18 June 2025",
      description:
        "Last day to submit your nominations for the Corporate Excellence Awards. Ensure all required documents and criteria are met before the deadline.",
    },
    {
      ...
      date: "19 June 2025",
      description:
        "Our esteemed panel of industry experts will begin evaluating all nominations. Finalists will be selected based on merit and adherence to criteria.",
    },
    {
      ...
      date: "To be Updated",
      description:
        "Shortlisted nominees will be officially announced and notified. Preparations for the awards ceremony will commence.",
    },
    {
      ...
      date: "28 June 2025",
      description:
        "Join us to celebrate the pinnacle of corporate achievement. Finalists and winners will be honored at our prestigious annual awards ceremony.",
    },
    {
      ...
      date: "Ongoing",
      description:
        "Winners will receive continued recognition through our media partners and official website. Celebrate your success with us throughout the year!",
    },
  ];
  ...
  return (
    ...
    <div className="nomination-process-container">
      {/* Section Title */}
      <h2 className="section-title">Our Nomination Process</h2>
